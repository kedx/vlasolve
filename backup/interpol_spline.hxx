...
{   
  ...
  typedef scaleT::valLocationType valLocationType;
  typedef scaleT::valLocationTypeVal valLocationTypeVal;  
			  ...
			  double ybcvL=0,double ybcvR=0)
  {
    ...
    /*
    //ugridT xgrid,ygrid;
    if (vltype==valLocationTypeVal::VERTEX)
      {
	...
	//g.xgrid.num=Nx-1;g.ygrid.num=Ny-1;
