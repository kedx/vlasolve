...
#include "initGen_PowerLawDensitySphere.hxx"
#include "initGen_Plummer.hxx"
#include "initGen_Hernquist.hxx"
#include "initGen_testNN.hxx"
...
private:
  ...
  {
    initAll.push_back(static_cast<initGenT*>(new UniformDensitySphere<gridT>()));
    initAll.push_back(static_cast<initGenT*>(new PowerLawDensitySphere<gridT>()));
    initAll.push_back(static_cast<initGenT*>(new Plummer<gridT>()));
    initAll.push_back(static_cast<initGenT*>(new Hernquist<gridT>()));
    initAll.push_back(static_cast<initGenT*>(new testNN<gridT>()));

    // initAll.push_back((initGenT *)new UniformDensitySphere<gridT>());
    // initAll.push_back((initGenT *)new PowerLawDensitySphere<gridT>());
    // initAll.push_back((initGenT *)new Plummer<gridT>());
    // initAll.push_back((initGenT *)new Hernquist<gridT>());
    // initAll.push_back((initGenT *)new testNN<gridT>());
  }
